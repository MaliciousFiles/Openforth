...
public class HandRune : Clickable
{
    ...
    private void Start()
    {
        ...
        targetScale = Vector3.Scale(origScale, new(1.5f, 1.5f, 1));
    ...
    private void Update()
    {
        ...
        float zMod = 0.32f; // how far to move forward to still be able to see the rune in the game
        float yMod = 0.06f; // how far to move upward to put this rune above the others
        ...
        inMotion &= (focused ? targetPos : origPos) != camera.localPosition && (focused ? targetRot : origRot) != camera.localRotation;
    }
}
